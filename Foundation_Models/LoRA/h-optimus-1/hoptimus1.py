...
# Logging setup
log_file = "/data/MELBA-AmiBr/amibr_foundation_models/lora_better/hoptimus1_new/hoptimus1_lora_training.log"
logging.basicConfig(
    level=logging.INFO,
...
for fold, (train_idx, val_idx) in enumerate(strat_group_kfold.split(images, labels, groups)):
    ...
    best_val_acc = 0.0
    best_model_path = f'/data/MELBA-AmiBr/amibr_foundation_models/lora_better/hoptimus1_new/hoptimus1_lora_fold_{fold + 1}_best.pth'
    epochs_no_improve = 0
